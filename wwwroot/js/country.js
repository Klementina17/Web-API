...
function loadDataTable() {
    dataTable = $('#tblData').DataTable({
        ...
        "columns": [
            { data: 'countryName', "width": "50%" },        
            {
                data: 'countryId',
                "render": function (data) {
                    return `<div class="w-75 btn-group role=group">
                    <a href="/api/country/upsert?id=${data}" class="btn btn-primary mx-2"><i class="bi bi-pencil-square"></i>Edit</a>
                    <a onclick="Delete('/api/country/delete/${data}')" class="btn btn-danger mx-2"><i class="bi bi-trash-fill"></i>Delete</a>
                    </div>`;
                },
                "width": "30%"
            }
